...
list = [5, 7, 10, 12, 15, 17, 20, 22, 25, 27, 30, 32, 35]
...
plt.plot(big_list, execution_times[name], label=name, marker='o')
...
for n, exec_time in zip(big_list, execution_times[name]):
